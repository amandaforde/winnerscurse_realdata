...
rmse_BMI1 <- data.frame(naive = sqrt(mean((true_beta - out_EB_sig$beta)^2) - mean(out_EB_sig$se^2)), beta_EB = sqrt(mean((true_beta - out_EB_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_EB_scam = sqrt(mean((true_beta - out_EB_scam_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_EB_prune = sqrt(mean((true_beta - out_EB_prune_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_EB_df = sqrt(mean((true_beta - out_EB_df_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_FIQT = sqrt(mean((true_beta - out_FIQT_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2)), beta_FIQT2 = sqrt(mean((true_beta - out_FIQT2_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2)), beta_boot = sqrt(mean((true_beta - out_BR_ss_sig$beta_BR_ss)^2) - mean(out_EB_sig$se^2)))
...
rmse_BMI1_5e_4 <- data.frame(naive = sqrt(mean((true_beta - out_EB_sig$beta)^2) - mean(out_EB_sig$se^2)), beta_EB = sqrt(mean((true_beta - out_EB_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_EB_scam = sqrt(mean((true_beta - out_EB_scam_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_EB_prune = sqrt(mean((true_beta - out_EB_prune_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_EB_df = sqrt(mean((true_beta - out_EB_df_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_FIQT = sqrt(mean((true_beta - out_FIQT_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2)), beta_FIQT2 = sqrt(mean((true_beta - out_FIQT2_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2)), beta_boot = sqrt(mean((true_beta - out_BR_ss_sig$beta_BR_ss)^2) - mean(out_EB_sig$se^2)))
...
rmse_BMI2 <- data.frame(naive = sqrt(mean((true_beta - out_EB_sig$beta)^2) - mean(out_EB_sig$se^2)), beta_EB = sqrt(mean((true_beta - out_EB_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_EB_scam = sqrt(mean((true_beta - out_EB_scam_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_EB_df = sqrt(mean((true_beta - out_EB_df_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_FIQT = sqrt(mean((true_beta - out_FIQT_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2)), beta_FIQT2 = sqrt(mean((true_beta - out_FIQT2_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2)), beta_boot = sqrt(mean((true_beta - out_BR_ss_sig$beta_BR_ss)^2) - mean(out_EB_sig$se^2)))
...
rmse_BMI2_5e_4 <- data.frame(naive = sqrt(mean((true_beta - out_EB_sig$beta)^2) - mean(out_EB_sig$se^2)), beta_EB = sqrt(mean((true_beta - out_EB_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_EB_scam = sqrt(mean((true_beta - out_EB_scam_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_EB_df = sqrt(mean((true_beta - out_EB_df_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_FIQT = sqrt(mean((true_beta - out_FIQT_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2)), beta_FIQT2 = sqrt(mean((true_beta - out_FIQT2_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2)), beta_boot = sqrt(mean((true_beta - out_BR_ss_sig$beta_BR_ss)^2) - mean(out_EB_sig$se^2)))
...
rmse_T2D1 <- data.frame(naive = sqrt(mean((true_beta - out_EB_sig$beta)^2) - mean(out_EB_sig$se^2)), beta_EB = sqrt(mean((true_beta - out_EB_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_EB_scam = sqrt(mean((true_beta - out_EB_scam_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_EB_df = sqrt(mean((true_beta - out_EB_df_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_FIQT = sqrt(mean((true_beta - out_FIQT_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2)), beta_FIQT2 = sqrt(mean((true_beta - out_FIQT2_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2)), beta_boot = sqrt(mean((true_beta - out_BR_ss_sig$beta_BR_ss)^2) - mean(out_EB_sig$se^2)))
...
rmse_T2D1_5e_4 <- data.frame(naive = sqrt(mean((true_beta - out_EB_sig$beta)^2) - mean(out_EB_sig$se^2)), beta_EB = sqrt(mean((true_beta - out_EB_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_EB_scam = sqrt(mean((true_beta - out_EB_scam_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_EB_df = sqrt(mean((true_beta - out_EB_df_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_FIQT = sqrt(mean((true_beta - out_FIQT_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2)), beta_FIQT2 = sqrt(mean((true_beta - out_FIQT2_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2)), beta_boot = sqrt(mean((true_beta - out_BR_ss_sig$beta_BR_ss)^2) - mean(out_EB_sig$se^2)))
...
rmse_T2D2 <- data.frame(naive = sqrt(mean((true_beta - out_EB_sig$beta)^2) - mean(out_EB_sig$se^2)), beta_EB = sqrt(mean((true_beta - out_EB_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_EB_scam = sqrt(mean((true_beta - out_EB_scam_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_EB_df = sqrt(mean((true_beta - out_EB_df_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_FIQT = sqrt(mean((true_beta - out_FIQT_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2)), beta_FIQT2 = sqrt(mean((true_beta - out_FIQT2_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2)), beta_boot = sqrt(abs(mean((true_beta - out_BR_ss_sig$beta_BR_ss)^2) - mean(out_EB_sig$se^2))))
...
rmse_T2D2_5e_4 <- data.frame(naive = sqrt(mean((true_beta - out_EB_sig$beta)^2) - mean(out_EB_sig$se^2)), beta_EB = sqrt(mean((true_beta - out_EB_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_EB_scam = sqrt(mean((true_beta - out_EB_scam_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_EB_df = sqrt(mean((true_beta - out_EB_df_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_FIQT = sqrt(mean((true_beta - out_FIQT_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2)), beta_FIQT2 = sqrt(mean((true_beta - out_FIQT2_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2)), beta_boot = sqrt(mean((true_beta - out_BR_ss_sig$beta_BR_ss)^2) - mean(out_EB_sig$se^2)))
...
mse_height1 <- data.frame(naive = mean((true_beta - out_CL$beta)^2) - mean(out_EB_sig$se^2), beta.cl1 = mean((true_beta - out_CL$beta.cl1)^2) - mean(out_EB_sig$se^2),  beta.cl2 = mean((true_beta - out_CL$beta.cl2)^2) - mean(out_EB_sig$se^2),  beta.cl3 = mean((true_beta - out_CL$beta.cl3)^2) - mean(out_EB_sig$se^2), beta_EB = mean((true_beta - out_EB_sig$beta_EB)^2) - mean(out_EB_sig$se^2), beta_EB_scam = mean((true_beta - out_EB_scam_sig$beta_EB)^2) - mean(out_EB_sig$se^2),  beta_EB_df = mean((true_beta - out_EB_df_sig$beta_EB)^2) - mean(out_EB_sig$se^2), beta_FIQT = mean((true_beta - out_FIQT_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2), beta_FIQT2 = mean((true_beta - out_FIQT2_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2), beta_boot = mean((true_beta - out_BR_ss_sig$beta_BR_ss)^2) - mean(out_EB_sig$se^2))

rmse_height1 <- data.frame(naive = sqrt(mean((true_beta - out_CL$beta)^2) - mean(out_EB_sig$se^2)), beta.cl1 = sqrt(mean((true_beta - out_CL$beta.cl1)^2) - mean(out_EB_sig$se^2)),  beta.cl2 = sqrt(mean((true_beta - out_CL$beta.cl2)^2) - mean(out_EB_sig$se^2)),  beta.cl3 = sqrt(mean((true_beta - out_CL$beta.cl3)^2) - mean(out_EB_sig$se^2)), beta_EB = sqrt(mean((true_beta - out_EB_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_EB_scam = sqrt(mean((true_beta - out_EB_scam_sig$beta_EB)^2) - mean(out_EB_sig$se^2)),  beta_EB_df = sqrt(mean((true_beta - out_EB_df_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_FIQT = sqrt(mean((true_beta - out_FIQT_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2)), beta_FIQT2 = sqrt(mean((true_beta - out_FIQT2_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2)), beta_boot = sqrt(mean((true_beta - out_BR_ss_sig$beta_BR_ss)^2) - mean(out_EB_sig$se^2)))

mse.n_height1 <- data.frame(naive = sum((true_beta - out_CL$beta)^2) - sum(out_EB_sig$se^2), beta.cl1 = sum((true_beta - out_CL$beta.cl1)^2) - sum(out_EB_sig$se^2),  beta.cl2 = sum((true_beta - out_CL$beta.cl2)^2) - sum(out_EB_sig$se^2),  beta.cl3 = sum((true_beta - out_CL$beta.cl3)^2) - sum(out_EB_sig$se^2), beta_EB = sum((true_beta - out_EB_sig$beta_EB)^2) - sum(out_EB_sig$se^2), beta_EB_scam = sum((true_beta - out_EB_scam_sig$beta_EB)^2) - sum(out_EB_sig$se^2), beta_EB_df = sum((true_beta - out_EB_df_sig$beta_EB)^2) - sum(out_EB_sig$se^2), beta_FIQT = sum((true_beta - out_FIQT_sig$beta_FIQT)^2) - sum(out_EB_sig$se^2), beta_FIQT2 = sum((true_beta - out_FIQT2_sig$beta_FIQT)^2) - sum(out_EB_sig$se^2), beta_boot = sum((true_beta - out_BR_ss_sig$beta_BR_ss)^2) - sum(out_EB_sig$se^2))
...
mse_height1_5e_4 <- data.frame(naive = mean((true_beta2 - out_CL2$beta)^2) - mean(out_CL2$se^2), beta.cl1 = mean((true_beta2 - out_CL2$beta.cl1)^2) - mean(out_CL2$se^2),  beta.cl2 = mean((true_beta2 - out_CL2$beta.cl2)^2) - mean(out_CL2$se^2),  beta.cl3 = mean((true_beta2 - out_CL2$beta.cl3)^2) - mean(out_CL2$se^2), beta_EB = mean((true_beta2 - out_EB_sig$beta_EB)^2) - mean(out_CL2$se^2), beta_EB_scam = mean((true_beta2 - out_EB_scam_sig$beta_EB)^2) - mean(out_CL2$se^2), beta_EB_df = mean((true_beta2 - out_EB_df_sig$beta_EB)^2) - mean(out_CL2$se^2), beta_FIQT = mean((true_beta2 - out_FIQT_sig$beta_FIQT)^2) - mean(out_CL2$se^2), beta_FIQT2 = mean((true_beta2 - out_FIQT2_sig$beta_FIQT)^2) - mean(out_CL2$se^2), beta_BR_ss = mean((true_beta2 - out_BR_ss_sig$beta_BR_ss)^2) - mean(out_CL2$se^2))

rmse_height1_5e_4 <- data.frame(naive = sqrt(mean((true_beta2 - out_CL2$beta)^2) - mean(out_CL2$se^2)), beta.cl1 = sqrt(mean((true_beta2 - out_CL2$beta.cl1)^2) - mean(out_CL2$se^2)),  beta.cl2 = sqrt(mean((true_beta2 - out_CL2$beta.cl2)^2) - mean(out_CL2$se^2)),  beta.cl3 = sqrt(mean((true_beta2 - out_CL2$beta.cl3)^2) - mean(out_CL2$se^2)), beta_EB = sqrt(mean((true_beta2 - out_EB_sig$beta_EB)^2) - mean(out_CL2$se^2)), beta_EB_scam = sqrt(mean((true_beta2 - out_EB_scam_sig$beta_EB)^2) - mean(out_CL2$se^2)), beta_EB_df = sqrt(mean((true_beta2 - out_EB_df_sig$beta_EB)^2) - mean(out_CL2$se^2)), beta_FIQT = sqrt(mean((true_beta2 - out_FIQT_sig$beta_FIQT)^2) - mean(out_CL2$se^2)), beta_FIQT2 = sqrt(mean((true_beta2 - out_FIQT2_sig$beta_FIQT)^2) - mean(out_CL2$se^2)), beta_BR_ss = sqrt(mean((true_beta2 - out_BR_ss_sig$beta_BR_ss)^2) - mean(out_CL2$se^2)))

mse.n_height1_5e_4 <- data.frame(naive = sum((true_beta2 - out_CL2$beta)^2) - sum(out_EB_sig$se^2), beta.cl1 = sum((true_beta2 - out_CL2$beta.cl1)^2) - sum(out_EB_sig$se^2),  beta.cl2 = sum((true_beta2 - out_CL2$beta.cl2)^2) - sum(out_EB_sig$se^2),  beta.cl3 = sum((true_beta2 - out_CL2$beta.cl3)^2) - sum(out_EB_sig$se^2), beta_EB = sum((true_beta2 - out_EB_sig$beta_EB)^2) - sum(out_EB_sig$se^2), beta_EB_scam = sum((true_beta2 - out_EB_scam_sig$beta_EB)^2) - sum(out_EB_sig$se^2), beta_EB_df = sum((true_beta2 - out_EB_df_sig$beta_EB)^2) - sum(out_EB_sig$se^2), beta_FIQT = sum((true_beta2 - out_FIQT_sig$beta_FIQT)^2) - sum(out_EB_sig$se^2), beta_FIQT2 = sum((true_beta2 - out_FIQT2_sig$beta_FIQT)^2) - sum(out_EB_sig$se^2), beta_boot = sum((true_beta2 - out_BR_ss_sig$beta_BR_ss)^2) - sum(out_EB_sig$se^2))
```
...
mse_height2 <- data.frame(naive = mean((true_beta - out_CL$beta)^2) - mean(out_EB_sig$se^2), beta.cl1 = mean((true_beta - out_CL$beta.cl1)^2) - mean(out_EB_sig$se^2),  beta.cl2 = mean((true_beta - out_CL$beta.cl2)^2) - mean(out_EB_sig$se^2),  beta.cl3 = mean((true_beta - out_CL$beta.cl3)^2) - mean(out_EB_sig$se^2), beta_EB = mean((true_beta - out_EB_sig$beta_EB)^2) - mean(out_EB_sig$se^2), beta_EB_scam = mean((true_beta - out_EB_scam_sig$beta_EB)^2) - mean(out_EB_sig$se^2), beta_EB_df = mean((true_beta - out_EB_df_sig$beta_EB)^2) - mean(out_EB_sig$se^2), beta_FIQT = mean((true_beta - out_FIQT_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2), beta_FIQT2 = mean((true_beta - out_FIQT2_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2), beta_boot = mean((true_beta - out_BR_ss_sig$beta_BR_ss)^2) - mean(out_EB_sig$se^2))

rmse_height2 <- data.frame(naive = sqrt(mean((true_beta - out_CL$beta)^2) - mean(out_EB_sig$se^2)), beta.cl1 = sqrt(mean((true_beta - out_CL$beta.cl1)^2) - mean(out_EB_sig$se^2)),  beta.cl2 = sqrt(mean((true_beta - out_CL$beta.cl2)^2) - mean(out_EB_sig$se^2)),  beta.cl3 = sqrt(mean((true_beta - out_CL$beta.cl3)^2) - mean(out_EB_sig$se^2)), beta_EB = sqrt(mean((true_beta - out_EB_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_EB_scam = sqrt(mean((true_beta - out_EB_scam_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_EB_df = sqrt(mean((true_beta - out_EB_df_sig$beta_EB)^2) - mean(out_EB_sig$se^2)), beta_FIQT = sqrt(mean((true_beta - out_FIQT_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2)), beta_FIQT2 = sqrt(mean((true_beta - out_FIQT2_sig$beta_FIQT)^2) - mean(out_EB_sig$se^2)), beta_boot = sqrt(mean((true_beta - out_BR_ss_sig$beta_BR_ss)^2) - mean(out_EB_sig$se^2)))

mse.n_height2 <- data.frame(naive = sum((true_beta - out_CL$beta)^2) - sum(out_EB_sig$se^2), beta.cl1 = sum((true_beta - out_CL$beta.cl1)^2) - sum(out_EB_sig$se^2),  beta.cl2 = sum((true_beta - out_CL$beta.cl2)^2) - sum(out_EB_sig$se^2),  beta.cl3 = sum((true_beta - out_CL$beta.cl3)^2) - sum(out_EB_sig$se^2), beta_EB = sum((true_beta - out_EB_sig$beta_EB)^2) - sum(out_EB_sig$se^2), beta_EB_scam = sum((true_beta - out_EB_scam_sig$beta_EB)^2) - sum(out_EB_sig$se^2), beta_EB_df = sum((true_beta - out_EB_df_sig$beta_EB)^2) - sum(out_EB_sig$se^2),  beta_FIQT = sum((true_beta - out_FIQT_sig$beta_FIQT)^2) - sum(out_EB_sig$se^2), beta_FIQT2 = sum((true_beta - out_FIQT2_sig$beta_FIQT)^2) - sum(out_EB_sig$se^2), beta_boot = sum((true_beta - out_BR_ss_sig$beta_BR_ss)^2) - sum(out_EB_sig$se^2))
...
mse_height2_5e_4 <- data.frame(naive = mean((true_beta2 - out_CL2$beta)^2) - mean(out_CL2$se^2), beta.cl1 = mean((true_beta2 - out_CL2$beta.cl1)^2) - mean(out_CL2$se^2),  beta.cl2 = mean((true_beta2 - out_CL2$beta.cl2)^2) - mean(out_CL2$se^2),  beta.cl3 = mean((true_beta2 - out_CL2$beta.cl3)^2) - mean(out_CL2$se^2), beta_EB = mean((true_beta2 - out_EB_sig$beta_EB)^2) - mean(out_CL2$se^2),  beta_EB_scam = mean((true_beta2 - out_EB_scam_sig$beta_EB)^2) - mean(out_CL2$se^2),  beta_EB_df = mean((true_beta2 - out_EB_df_sig$beta_EB)^2) - mean(out_CL2$se^2), beta_FIQT = mean((true_beta2 - out_FIQT_sig$beta_FIQT)^2) - mean(out_CL2$se^2),  beta_FIQT2 = mean((true_beta2 - out_FIQT2_sig$beta_FIQT)^2) - mean(out_CL2$se^2), beta_BR_ss = mean((true_beta2 - out_BR_ss_sig$beta_BR_ss)^2) - mean(out_CL2$se^2))

rmse_height2_5e_4 <- data.frame(naive = sqrt(mean((true_beta2 - out_CL2$beta)^2) - mean(out_CL2$se^2)), beta.cl1 = sqrt(mean((true_beta2 - out_CL2$beta.cl1)^2) - mean(out_CL2$se^2)),  beta.cl2 = sqrt(mean((true_beta2 - out_CL2$beta.cl2)^2) - mean(out_CL2$se^2)),  beta.cl3 = sqrt(mean((true_beta2 - out_CL2$beta.cl3)^2) - mean(out_CL2$se^2)), beta_EB = sqrt(mean((true_beta2 - out_EB_sig$beta_EB)^2) - mean(out_CL2$se^2)),  beta_EB_scam = sqrt(mean((true_beta2 - out_EB_scam_sig$beta_EB)^2) - mean(out_CL2$se^2)),  beta_EB_df = sqrt(mean((true_beta2 - out_EB_df_sig$beta_EB)^2) - mean(out_CL2$se^2)), beta_FIQT = sqrt(mean((true_beta2 - out_FIQT_sig$beta_FIQT)^2) - mean(out_CL2$se^2)),  beta_FIQT2 = sqrt(mean((true_beta2 - out_FIQT2_sig$beta_FIQT)^2) - mean(out_CL2$se^2)), beta_BR_ss = sqrt(mean((true_beta2 - out_BR_ss_sig$beta_BR_ss)^2) - mean(out_CL2$se^2)))

mse.n_height2_5e_4 <- data.frame(naive = sum((true_beta2 - out_CL2$beta)^2) - sum(out_EB_sig$se^2), beta.cl1 = sum((true_beta2 - out_CL2$beta.cl1)^2) - sum(out_EB_sig$se^2),  beta.cl2 = sum((true_beta2 - out_CL2$beta.cl2)^2) - sum(out_EB_sig$se^2),  beta.cl3 = sum((true_beta2 - out_CL2$beta.cl3)^2) - sum(out_EB_sig$se^2), beta_EB = sum((true_beta2 - out_EB_sig$beta_EB)^2) - sum(out_EB_sig$se^2), beta_EB_scam = sum((true_beta2 - out_EB_scam_sig$beta_EB)^2) - sum(out_EB_sig$se^2), beta_EB_df = sum((true_beta2 - out_EB_df_sig$beta_EB)^2) - sum(out_EB_sig$se^2), beta_FIQT = sum((true_beta2 - out_FIQT_sig$beta_FIQT)^2) - sum(out_EB_sig$se^2), beta_FIQT2 = sum((true_beta2 - out_FIQT2_sig$beta_FIQT)^2) - sum(out_EB_sig$se^2), beta_boot = sum((true_beta2 - out_BR_ss_sig$beta_BR_ss)^2) - sum(out_EB_sig$se^2))
```
